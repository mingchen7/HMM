...
ggplot(MAE.all,aes(sum,fill=method)) + geom_density(alpha=0.5) + theme_bw() + scale_fill_manual(values = c("red", "purple","white","green")) +
...
ggplot(MAPE.all,aes(sum,fill=method)) + geom_density(alpha=0.5) + theme_bw() + scale_fill_manual(values = c("red", "purple","white","green")) +
    theme(title=element_text(face="bold",size=16),      
          axis.title.y = element_text(face="bold", size=16),
          axis.text = element_text(colour="#000000", size=16),
          legend.title = element_text(size=16),
